...
public class UseSongMeaningsOptionListener implements ItemListener {

	@Override
	public void itemStateChanged(ItemEvent e) {
		if(((JCheckBoxMenuItem)e.getSource()).isSelected() == true)
			MainFrame.getOptions().setProperty("UseSongMeanings", "true");
		else
			MainFrame.getOptions().setProperty("UseSongMeanings", "false");
	}
