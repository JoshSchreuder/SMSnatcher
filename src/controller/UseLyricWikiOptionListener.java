...
public class UseLyricWikiOptionListener implements ItemListener {

	@Override
	public void itemStateChanged(ItemEvent e) {
		if(((JCheckBoxMenuItem)e.getSource()).isSelected() == true)
			MainFrame.getOptions().setProperty("UseLyricWiki", "true");
		else
			MainFrame.getOptions().setProperty("UseLyricWiki", "false");
	}
